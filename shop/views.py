...
from shop.serializers import UserSerializer,ProductSerializer,BasketItemSerializer,BasketSerializer,OrderSerializer
...
KEY_ID="rzp_test_TuTLrbB4ACmX09"
KEY_SECRET="VOuTKSh6Zyhq4elwpAwpEuzu"
...
class OrderSummaryView(ListAPIView):
      ...
      def get_queryset(self):
            return Order.objects.filter(user_objects=self.request.user)
